...
typedef VoidFunc CreateStream<T>(EventSink<T> sink);
...
class Observable<T> extends Stream<T> {
  ...
  factory Observable.create(CreateStream<T> createStream) {
    final StreamController<T> controller = StreamController<T>();
    controller.onListen = () => controller.onCancel = createStream(controller);
